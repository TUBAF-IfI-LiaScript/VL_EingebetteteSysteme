...
class FreeOutIO extends WebInterfaceFjangComponent {
    constructor(inputTextClassName) {
        super();
        this.valueNode = new FjangNode(FreeDatatype.STATIC);
        let current = this;
        this.elmnt = document.createElement("input");
        this.elmnt.disabled = true;
        this.elmnt.type = "text";
        this.elmnt.className = inputTextClassName;
        this.elmnt.value = "undefined";
    }
    getNodes() {
    ...
    tick() {
        this.elmnt.value = this.valueNode.get();
    }
}
