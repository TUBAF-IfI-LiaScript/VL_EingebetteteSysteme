...
[https://github.com/TUBAF-IfI-LiaScript/VL_EingebetteteSysteme/blob/master/13_AVR_CPU.md](https://github.com/TUBAF-IfI-LiaScript/VL_EingebetteteSysteme/blob/master/13_AVR_CPU.md)

Die interaktive Form ist unter [diesem Link](https://liascript.github.io/course/?https://raw.githubusercontent.com/TUBAF-IfI-LiaScript/VL_EingebetteteSysteme/master/13_AVR_CPU.md) zu finden
...
![Bild](./images/13_AVR_CPU/AtTiny.png)<!-- style="width: 75%; max-width: 500px" -->[^1]
![Bild](./images/13_AVR_CPU/ATTINY13A.jpeg)<!-- style="width: 25%; max-width: 200px" -->

[^1]: Firma Microchip, Handbuch AtTiny Family, https://ww1.microchip.com/downloads/en/DeviceDoc/Atmel-2586-AVR-8-bit-Microcontroller-ATtiny25-ATtiny45-ATtiny85_Datasheet.pdf
...
![Bild](./images/13_AVR_CPU/AVR-8Bit-Vergleich.png)<!-- style="width: 75%; max-width: 500px" -->[^2]
...
![Bild](./images/13_AVR_CPU/UebersichtCortexM0.png)<!-- style="width: 65%; max-width: 500px" -->[^4]
...
![Bild](./images/13_AVR_CPU/STM32F0-Vergleich.png)<!-- style="width: 75%; max-width: 500px" -->[^5]
...
![Bild](./images/13_AVR_CPU/PINBelegung.png)<!-- style="width: 100%; max-width: 1000px" -->[^5]

[^5]: Firma Microchip, megaAVR® Data Sheet, Seite 12, [Link](http://ww1.microchip.com/downloads/en/DeviceDoc/ATmega48A-PA-88A-PA-168A-PA-328-P-DS-DS40002061A.pdf)
...
![Bild](./images/13_AVR_CPU/LowFrequency_Stromaufnahme.png)<!-- style="width: 75%; max-width: 1000px" -->[^6]

![Bild](./images/13_AVR_CPU/HighFrequency_Stromaufnahme.png)<!-- style="width: 65%; max-width: 1000px" -->[^6]

[^6]: Firma Microchip, megaAVR® Data Sheet, Seite 597, [Link](http://ww1.microchip.com/downloads/en/DeviceDoc/ATmega48A-PA-88A-PA-168A-PA-328-P-DS-DS40002061A.pdf)

![Bild](./images/13_AVR_CPU/MaximaleStromaufnahme.png)<!-- style="width: 85%; max-width: 1000px" -->[^7]

[^7]: Firma Microchip, megaAVR® Data Sheet, Seite 312, [Link](http://ww1.microchip.com/downloads/en/DeviceDoc/ATmega48A-PA-88A-PA-168A-PA-328-P-DS-DS40002061A.pdf)
...
![Bild](./images/13_AVR_CPU/SleepModes.png)<!-- style="width: 85%; max-width: 1000px" -->[^7]

[^7]: Firma Microchip, megaAVR® Data Sheet, Seite 47, [Link](http://ww1.microchip.com/downloads/en/DeviceDoc/ATmega48A-PA-88A-PA-168A-PA-328-P-DS-DS40002061A.pdf)
...
![Bild](./images/13_AVR_CPU/Taktgenerierung.png)<!-- style="width: 75%; max-width: 1000px" -->[^8]

[^8]: Firma Microchip, megaAVR® Data Sheet, Seite 36, [Link](http://ww1.microchip.com/downloads/en/DeviceDoc/ATmega48A-PA-88A-PA-168A-PA-328-P-DS-DS40002061A.pdf)
...
![Bild](./images/13_AVR_CPU/RC_Oscillator.png)<!-- style="width: 75%; max-width: 1000px" -->[^8]

[^8]: Firma Microchip, megaAVR® Data Sheet, Seite 312, [Link](http://ww1.microchip.com/downloads/en/DeviceDoc/ATmega48A-PA-88A-PA-168A-PA-328-P-DS-DS40002061A.pdf)
...
![Bild](./images/13_AVR_CPU/AVR_core_Speicher.png)<!-- style="width: 55%; max-width: 1000px" -->[^9]

[^9]: Firma Microchip, megaAVR® Data Sheet, Seite 18, [Link](http://ww1.microchip.com/downloads/en/DeviceDoc/ATmega48A-PA-88A-PA-168A-PA-328-P-DS-DS40002061A.pdf)
...
![Bild](./images/13_AVR_CPU/Memory_Map.png)<!-- style="width: 75%; max-width: 1000px" -->[^10]

[^10]: Firma Microchip, megaAVR® Data Sheet, Seite 28, [Link](http://ww1.microchip.com/downloads/en/DeviceDoc/ATmega48A-PA-88A-PA-168A-PA-328-P-DS-DS40002061A.pdf)
...
![Bild](./images/13_AVR_CPU/EEPROM.png)<!-- style="width: 75%; max-width: 1000px" -->

### Reset-System

![Bild](./images/13_AVR_CPU/ResetSystem.png)<!-- style="width: 75%; max-width: 1000px" -->[^11]

[^11]: Firma Microchip, megaAVR® Data Sheet, Seite 57, [Link](http://ww1.microchip.com/downloads/en/DeviceDoc/ATmega48A-PA-88A-PA-168A-PA-328-P-DS-DS40002061A.pdf)
...
![Bild](./images/13_AVR_CPU/IO_ATmega.png)<!-- style="width: 75%; max-width: 1000px" -->[^12]

[^12]: Firma Microchip, megaAVR® Data Sheet, Seite 85, [Link](http://ww1.microchip.com/downloads/en/DeviceDoc/ATmega48A-PA-88A-PA-168A-PA-328-P-DS-DS40002061A.pdf)
...
![Bild](./images/13_AVR_CPU/ZeitverhaltenIO.png)<!-- style="width: 75%; max-width: 1000px" -->[^13]

[^13]: Firma Microchip, megaAVR® Data Sheet, Seite 86, [Link](http://ww1.microchip.com/downloads/en/DeviceDoc/ATmega48A-PA-88A-PA-168A-PA-328-P-DS-DS40002061A.pdf)

## Integration in Schaltung

Und wie setzen wir das Ganze in einer konkreten Schaltung um?

![Bild](./images/13_AVR_CPU/ArduinoDrawing.png)<!-- style="width: 85%; max-width: 1000px" -->[^14]

[^14]: Arduino Webseite [Link](https://content.arduino.cc/assets/UNO-TH_Rev3e_sch.pdf)

![Bild](./images/13_AVR_CPU/ArduinoBoard.jpeg)<!-- style="width: 55%; max-width: 1000px" -->[^15]
